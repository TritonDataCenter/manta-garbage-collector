...
function validateConfig(config, callback) {
    ...
    try {
        ...
        assert.optionalNumber(config.dir_slow_put_cutoff, 'config.dir_slow_put_cutoff');
        assert.optionalNumber(config.dir_slow_put_max_failures, 'config.dir_slow_put_max_failures');
        assert.optionalNumber(config.dir_slow_put_disable_time, 'config.dir_slow_put_disable_time');
