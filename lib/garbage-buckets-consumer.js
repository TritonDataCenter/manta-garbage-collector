...
function GarbageBucketsConsumer(opts) {
    ...
    if (self.metricsManager) {
        self.metrics = {
            ...
            runCountTotal: self.metricsManager.collector.counter({
                ...
                help:
                    'Counter incremented every time the buckets-consumer looks ' +
            ...
            mdapiBatchDeleteCount: self.metricsManager.collector.counter({
                ...
                help:
                    'Number of deletegcbatch calls to delete batches of records ' +
                    'from mdapi.'
            }),
    ...
    // Note: we don't initialize mdapiRecordsRead here because it's always used
