...
function GarbageUploader(opts) {
    ...
    //
    self.slowPutCutoff =
        self.config.dir_slow_put_cutoff || DEFAULT_SLOW_PUT_CUTOFF;
    self.slowPutMaxFailures =
        self.config.dir_slow_put_max_failures || DEFAULT_SLOW_PUT_MAX_FAILURES;
    self.slowPutDisableTime =
        self.config.dir_slow_put_disable_time || DEFAULT_SLOW_PUT_DISABLE_TIME;
