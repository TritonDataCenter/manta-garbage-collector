...
var FAILED_SLOW_PUT_DISABLE_TIME = 6 * 60 * 60 * 1000; // ms to disable a server after failures (6h)
...
GarbageUploader.prototype.enableStorageId = function enableStorageId(storageId) {
    ...
    if (disableTimestamp) {
        ...
        self.log.debug('Enabled ' + storageId + ' which was disabled at ' + disableTimestamp);
    }
...
GarbageUploader.prototype.disableStorageId = function disableStorageId(storageId, disableTime) {
    ...
    if (disableTime > 0) {
        ...
        self.log.debug('Disabled ' + storageId + ' will reenable after at ' + disableTime);
    }
};
...
GarbageUploader.prototype.putInstructionFile = function putInstructionFile(
    ...
    function _handlePutFail(err, req, res) {
        ...
        if (elapsed > FAILED_SLOW_PUT_CUTOFF) {
            ...
            self.log.info('Slow PUT: ' + elapsed + 's: ' + self.storageServerFailedSlowPuts[storageId]);
                            ...
                            function _makeEventHandler(_dir, _storageId) {
                                return function _onEvent(_event) {
                                    ...
                                    self.log.trace(
                                        ...
                                        _dir,
                                        _event,
                                        ignored: self.disabledStorageIds[_storageId] ? true : false
                                    );
                                }.bind(self);
                            }
